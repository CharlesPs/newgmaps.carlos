...
class Admin_distritos extends CI_Controller {
	...
	function __construct(){
		...
		$this->main_model_name = "m_admin_distritos";
	}
	...
	public function index(){
		...
		$data->uri_segment 	= 3;
		$data->base_url 	= base_url()."admin/distritos/";
		...
		$output["web_content"] .= $this->load->view("back/v_distritos", $output, true);
	...
	public function view(){
		...
		$output["web_content"] .= $this->load->view("back/v_header", $output, true);
		$output["web_content"] .= $this->load->view("back/v_distritos_view", $output, true);
		$output["web_content"] .= $this->load->view("back/v_footer", $output, true);
