...
?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin/ecologico/view/<?php echo $row->entry; ?>" class="btn">
                                                <i class="icon-eye-open"></i> Ver
                                            </a>
                                            <a href="admin/ecologico/delete/<?php echo $row->entry; ?>" class="btn btn-danger">
